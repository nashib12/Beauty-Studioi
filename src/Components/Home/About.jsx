  ...
  return (
    <>
      <section id="about" className="bg-[#FFF6EF]">
        <div className="md:relative md:max-w-8xl mx-auto px-6 py-12 md:px-16 md:py-24">
          <img
            src={BgImage}
            alt="Background flower"
            className="hidden md:block h-screen w-auto object-cover"
          />
          <div className="md:absolute inset-0 md:px-16 md:py-24">
            <div className="grid md:grid-cols-2 gap-6 md:gap-18">
               <div>
