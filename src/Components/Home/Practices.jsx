  ...
  return (
    ...
    <section id='practices' className='bg-[#FFF6EF] pb-24'>
        <div className='md:relative'>
            ...
            <div className='md:absolute inset-0 grid md:grid-cols-2 px-6 py-12 md:px-24 md:py-24 gap-6 md:gap-8'>
                <div className='flex flex-col gap-4'>
                  ...
                  <ul className='flex flex-col gap-4'>
                    ...
                    <li className='flex items-start gap-4'><img src={CheckboxImg} alt='checkbox' className='h-10 w-10 object-contain shrink-0' /><div><h3 className='text-[#663a30] text-2xl md:text-3xl mb-3 '>Stylish Makeovers</h3><p className='text-justify'>Occaecat laborum quis sint ut eiusmod eu adipisicing do. Incididunt nisi mollit ipsum ea eiusmod duis sint velit aliqua nisi sint aliquip pariatur. Aute commodo laboris sint ullamco consequat officia dolore irure sit sint tempor sunt.</p></div></li>
                  </ul>
                </div>
