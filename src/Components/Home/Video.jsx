    ...
    <>
      <section id="video">
        <div className="relative">
          ...
          />
          <button className="absolute left-8 bottom-58 md:bottom-40 md:left-34 bg-[#663A30] hover:bg-white border border-white md:border-0 cursor-pointer rounded-full h-22 w-22 flex items-center justify-center z-10 group transition-transform duration-300 ease-in-out hover:scale-95 hover:transalte-y-1 ripple-bg-gray-300">
